...
namespace Phalcon\Annotations\Docblock\Tests\Unit\Reader;
...
final class ParseTest extends AbstractUnitTestCase
{
    ...
    {
        $includeFile = $this->supportPath('assets/Annotations/TestClass.php');
    ...
    {
        $includeFile = $this->supportPath('assets/Annotations/TestInvalid.php');
